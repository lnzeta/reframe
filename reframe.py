...
class ReframeResult:
    has_issues: bool
    issues_per_row: pd.Series
    issues_per_column_count: pd.DataFrame
    issues_per_column: pd.DataFrame
    pass
...
def run_analysis(
    ...
    with (
        ...
        print("### Column-wise observations ###")
        print(
            tabulate(
                _prettify_index(result.issues_per_column),
                headers="keys",
                tablefmt="grid",
                colalign=["left"]
        ...
        print("### Column-wise observations - count ###")
        print(
            tabulate(
        ...
        print("### Row-wise observations ###")
        print(tabulate(_prettify_index(result.issues_per_row), tablefmt="simple"))
        print()
